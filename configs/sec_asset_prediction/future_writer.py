...
from mongoengine import connect, Document, IntField, StringField, BooleanField, ListField, DateTimeField, ReferenceField
...
def create_incident(arguments):
    ...
    inc = Incident(detected_by="correlation",incident_recorder="SEC (Simple Event Correlator)", state="open", description=arguments["description"], gravity=arguments["gravity"],incident_type=arguments["incident_type"],name=arguments["name"], future = True).save()
