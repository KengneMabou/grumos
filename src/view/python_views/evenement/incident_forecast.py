...
class IncidentForecastDialogue(GenericDialogue):
    ...
    def filter_incident_forecast (self, data_collect_interval, pattern_period, number_past_season_observed, t_forecast, equipement_observed, metric_instance_observed, plugin_instance_observed, type_instance_observed, past_time_to_plot):
    ...
    def ouvrir (self, data_collect_interval = None, pattern_period = None, number_past_season_observed = None, t_forecast = None, equipement_observed = None, metric_instance_observed = None, plugin_instance_observed = None, type_instance_observed= None, past_time_to_plot = None):
        ...
        from src.logic.evenement.incident_forecast_logic import IncidentForcastLogic
        ...
        if data_collect_interval is None:
            data_collect_interval = 10 # 10 secondes
        ...
        raw_metric = equipement_observed+"."+metric_instance_observed+"."+plugin_instance_observed+"."+type_instance_observed
        future_incidents = IncidentForcastLogic().correlate(equipement_observed,raw_metric, res['forecasted_data'])
        ...
        context = {
            ...
            "filtering_url": url_for('incident_forecast_urls.incident_forecast_handler'),
            "error":res['error']
        }
        
        return render_template('grumos_templates/event/incident/incident_forecast.html', **context)        
